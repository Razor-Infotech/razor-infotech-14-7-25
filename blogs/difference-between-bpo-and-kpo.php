            ...
            <div class="row" data-sticky_parent>
                <div class="col-xl-8" data-sticky_column>
                    ...
                    <div class="services-details__content">
                        ...
                        <h3>What Is BPO?</h3>
                        <p>BPO (Business Process Outsourcing) is a Process in which companies outsource their day-to-day tasks, which are not part of the core Business, to a specialist third party. Its main purpose is to reduce operational costs and increase efficiency. </p>

                        <h5>Main BPO Services </h5>
                        <ul>
                            <li><strong>Customer Support Services :</strong> providing support to customers through calls, emails, and live chat. This increases customer satisfaction and brand credibility</li>
                            <li><strong>Bank office service :</strong> Tasks such as <strong><a href="../data-entry-service">data entry</a></strong>, reporting, billing, and records management that are handled quietly away from the frontline.</li>
                            <li><strong>Content management Services :</strong> Updates, organization, and content publishing of websites or documents that are essential to a digital presence.</li>
                            <li><strong>IT help desk services :</strong> Providing technical support to companies, such as resolving password resets, system issues, and network problems.</li>
                            <li><strong>Back-End Outsourcing Services :</strong> Support Functions such as accounting, inventory, and management that handle the backend of the office.</li>
                        </ul>

                        <h3>What Is KPO?</h3>
                        <p>KPO ( Knowledge Process Outsourcing) requires a high level of expertise. These services are in areas where analysis, research, and decision-making ability are required. </p>

                        <h5>Major KPO Services </h5>
                        <ul>
                            <li><strong>Financial analysis :</strong> Understanding money matters, making the right investment decisions, budgeting, and calculating profit and loss.</li>
                            <li><strong>Legal research :</strong> Gathering information on legal matters, understanding legal documents, and finding information related to the case.</li>
                            <li><strong>Market research :</strong> Gathering information on what customers like, what is new in the market, and what other companies are doing.</li>
                            <li><strong>Research and development :</strong> Researching for new products and better services so that the company can move forward. </li>
                        </ul>
